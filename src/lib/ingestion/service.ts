...
async function executeIngestion(run: FetchRun, options: ResolvedRunOptions) {
  ...
  timelineCounters.clusterMerge = {
    ...
    softObjectConflictPairs: mergeResult.softObjectConflictPairs,
    softObjectConflictSelectedPairs: mergeResult.softObjectConflictSelectedPairs,
    softObjectConflictCleanPairsSkipped: mergeResult.softObjectConflictCleanPairsSkipped,
